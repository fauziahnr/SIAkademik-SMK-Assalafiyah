...
<head>
	<title>Login- SMK Assalafiyah</title>
	<meta charset="utf-8">
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{url('public/admin/assets/img/logo-smk.png') }}" alt="Klorofil Logo"></div>
							...
							<form class="form-auth-small" action="{{url('postlogin')}}" method="POST">
								...
								<div class="form-group">
									...
									<input name="email" type="email" class="form-control" id="signin-email" value="" placeholder="Username">
								</div>
								<div class="form-group">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">SMK ASSALAFIYAH</h1>
							<p>by Fauziah</p>
						</div>
					</div>
